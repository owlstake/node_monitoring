...
```
wget -O install_monitoring.sh https://raw.githubusercontent.com/owlstake/node_monitoring/master/install_monitoring.sh && chmod +x install_monitoring.sh && ./install_monitoring.sh
```
